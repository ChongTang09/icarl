...
class iCaRLNet(nn.Module):
    def __init__(self, feature_size, n_classes):
        ...
        self.cls_loss = nn.CrossEntropyLoss()  # Changed from BCELoss to BCEWithLogitsLoss
        self.dist_loss = nn.BCEWithLogitsLoss()  # Changed from BCELoss to BCEWithLogitsLoss
    ...
    def classify(self, x, transform):
        ...
        for i in range(feature.size(0)):
            feature[i] = feature[i] / feature[i].norm()
    ...
    def construct_exemplar_set(self, images, m, transform):
        ...
        for img in images:
            with torch.no_grad():
                ...
                feature = self.feature_extractor(x.unsqueeze(0)).detach().cpu().numpy()
